...
const solarSystem = [
  ...
  console.log("---------------------------------------")
  console.log("Jupiter's moons:", solarSystem[4].moons);
  console.log("---------------------------------------")
  
  // 2. Print the name of Neptune's moon "Nereid" to the console.
  
  console.log("Neptune's moon:", solarSystem[7].moons[1]);
  console.log("---------------------------------------")
  ...
  solarSystem[2].diamater = "7,926.2"
  console.log (solarSystem[2])
  console.log("---------------------------------------")
  
  // 6. Change Mercury's ringSystem boolean to true.
  
  solarSystem[2].ringSystem = true
  console.log ( solarSystem[2].ringSystem)
  console.log("---------------------------------------")
 ...
 console.log("---------------------------------------")
  ...
  // YALL SNEAKY >:( LMAO juptier number is a string. so annoying 
 ...
 console.log("---------------------------------------")
  ...
  let jupiter = (system.jupiter.velocity * system.jupiter.mass);
let pluto = (system.pluto.velocity * system.pluto.mass);
let difference = (jupiter - pluto);
